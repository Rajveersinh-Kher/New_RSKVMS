...
urlpatterns = [
    ...
    path('print-card/delete/<str:visit_id>/', delete_unprinted_visit_request, name='delete_unprinted_visit_request'),
    path('visitors/<str:visitor_id>/upload-photo/', upload_visitor_photo, name='upload_visitor_photo'),
